        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    {!!Form::model($docente,['route'=>['xdocente.update', $docente->id],'method'=>'PUT','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal'])!!}
                    ...
                    <div class="form-group">
                        <label for="inputPassword1" class="col-lg-2 control-label">Profesión</label>
                        <div class="col-lg-4">
                            {!!Form::text('profecion',null,['required'=>' ', 'autocomplete'=>'off', 'placeholder' =>'Profesión','class'=>'form-control'])!!}
                        </div>
