...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 class="page-title">Edicion Administradores</h2>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    {!!Form::model($administrador,['route'=>['xadministrador.update', $administrador->id],'method'=>'PUT','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal'])!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            ...
                            {{ Form::select('tipo_adm', [
                                       '2' => 'Auxiliar',],$administrador->tipo_adm
