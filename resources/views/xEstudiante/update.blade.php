...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 class="page-title">Edicion de Estudiante</h2>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    {!!Form::model($estudiante,['route'=>['xestudiante.update', $estudiante->id],'method'=>'PUT','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal'])!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            {!!Form::text('telefono',null,['required'=>' ', 'autocomplete'=>'off', 'placeholder' =>'Profesión','class'=>'form-control'])!!}
                        </div>
                    ...
                    <div class="hr-dashed"></div>
                    <div class="form-group">
                        <label for="inputPassword1" class="col-lg-2 control-label">Tutor</label>
                        <div class="col-lg-10">
                            {!!Form::select('tutor',$tutor,null)!!}
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <a href="{{route('admin.eread')}}" class="btn btn-danger btn-sm"> Cancel <i class=" fa fa-fast-forward"></i> </a>
